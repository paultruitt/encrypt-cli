...
pub fn add_contact(name: &str, key: &str) -> Result<(), EncryptLibError> {
...
pub fn load_identity(name: Option<String>) -> Result<Identity, EncryptLibError> {
...
pub fn create_keypair(pair_name: Option<String>) -> Result<String, EncryptLibError> {
...
pub fn name_to_recipient(recipient_name: &str) -> Result<Box<dyn age::Recipient + Send>, EncryptLibError> {
...
pub fn get_recipient_from_str(pubkey_str: &str) -> Result<Box<dyn age::Recipient + Send>, EncryptLibError> {
...
fn get_identity_from_str(privkey_str: &str) -> Result<Identity, EncryptLibError> {
...
fn save_pubkey(identity: &Identity, key_name: &String) -> Result<String, EncryptLibError> {
...
fn save_private(identity: &Identity, key_name: &String) -> Result<(), EncryptLibError> {
